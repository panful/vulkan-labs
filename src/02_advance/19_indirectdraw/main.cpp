    ...
    void RecordCommandBuffer(VkCommandBuffer command_buffer, VkFramebuffer framebuffer) const
    {
        ...
        if (m_support_multi_draw_indirect)
        {
            ...
            vkCmdDrawIndexedIndirect(
                command_buffer, m_indirect_buffer, 0, static_cast<uint32_t>(m_indirect_cmd.size()), sizeof(VkDrawIndexedIndirectCommand)
            );
        }
        else
        {
            ...
            {
                vkCmdDrawIndexedIndirect(
                    command_buffer, m_indirect_buffer, i * sizeof(VkDrawIndexedIndirectCommand), 1, sizeof(VkDrawIndexedIndirectCommand)
                );
            }
        }
