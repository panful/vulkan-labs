...
private:
    ...
    {
        auto vertShaderCode = ReadFile("../assets/shaders/02_16_base_vert.spv");
        auto fragShaderCode = ReadFile("../assets/shaders/02_16_base_frag.spv");
...
private:
    void CreateDrawables()
    {
        ...
        CreateTexture(m_texturePlane, "../assets/textures/nightsky.png");
    ...
    void CreateGraphicsPipeline()
    {
        auto vertShaderCode = ReadFile("../assets/shaders/02_16_texture_vert.spv");
        auto fragShaderCode = ReadFile("../assets/shaders/02_16_texture_frag.spv");
...
private:
    ...
    void CreateGraphicsPipeline()
    {
        auto vertShaderCode = ReadFile("../assets/shaders/02_16_offscreen_vert.spv");
        auto fragShaderCode = ReadFile("../assets/shaders/02_16_offscreen_frag.spv");
