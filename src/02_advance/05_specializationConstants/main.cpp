...
private:
    ...
    {
        //
        CreateGraphicsPipeline(m_graphics_pipelines.at(0), VK_PRIMITIVE_TOPOLOGY_TRIANGLE_LIST, VK_POLYGON_MODE_FILL, 0);
        //
        CreateGraphicsPipeline(m_graphics_pipelines.at(1), VK_PRIMITIVE_TOPOLOGY_TRIANGLE_LIST, VK_POLYGON_MODE_FILL, 1);
        //
        CreateGraphicsPipeline(m_graphics_pipelines.at(2), VK_PRIMITIVE_TOPOLOGY_TRIANGLE_LIST, VK_POLYGON_MODE_FILL, 2);
    }
    ...
    {
        auto vert_shader_code = ReadFile(PROJECT_ASSETS_DIR "shaders/02_05_base_vert.spv");
        auto frag_shader_code = ReadFile(PROJECT_ASSETS_DIR "shaders/02_05_base_frag.spv");
        ...
        specialization_data.color_mode = constant_id;
        ...
        specialization_map_entry.size                     = sizeof(SpecializationData);
        ...
        frag_shader_stage_info.pSpecializationInfo             = &specialization_info; // 着色器中的 constant_id
