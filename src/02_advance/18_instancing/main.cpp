...
private:
  ...
  void CreateGraphicsPipeline() {
    auto vertShaderCode = ReadFile(PROJECT_ASSETS_DIR "shaders/02_18_base_vert.spv");
    auto fragShaderCode = ReadFile(PROJECT_ASSETS_DIR "shaders/02_18_base_frag.spv");
