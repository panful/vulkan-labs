...
private:
  ...
  void CreateGraphicsPipeline() {
    auto vert_shader_code = ReadFile(PROJECT_SHADER_DIR "02_06_base_vert.spv");
    auto frag_shader_code = ReadFile(PROJECT_SHADER_DIR "02_06_base_frag.spv");
  ...
  void CreateGraphicsPipelineQuad() {
    auto vert_shader_code = ReadFile(PROJECT_SHADER_DIR "02_06_quad_vert.spv");
    auto frag_shader_code = ReadFile(PROJECT_SHADER_DIR "02_06_quad_frag.spv");
