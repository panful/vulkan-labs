...
private:
  ...
  void CreateGraphicsPipeline() {
    ...
    vkGetPipelineCacheData(m_device, m_pipeline_cache, &pipeline_cache_data_size,
                           reinterpret_cast<void*>(pipeline_cache_data.data()));
    ...
    if (write_pipeline_cache.good()) {
      write_pipeline_cache.write(reinterpret_cast<const char*>(pipeline_cache_data.data()),
                                 static_cast<std::streamsize>(pipeline_cache_data_size));
    ...
    if (VK_SUCCESS !=
        vkCreateGraphicsPipelines(m_device, m_pipeline_cache, 1, &pipeline_info, nullptr, &m_graphics_pipeline)) {
