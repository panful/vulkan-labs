...
private:
    ...
    void CreateGraphicsPipelineSmall()
    {
        ...
        if (VK_SUCCESS != vkCreateGraphicsPipelines(m_device, VK_NULL_HANDLE, 1, &pipeline_info, nullptr, &m_graphics_pipeline_small))
        {
    ...
    void CreateGraphicsPipelineLarge()
    {
        ...
        if (VK_SUCCESS != vkCreateGraphicsPipelines(m_device, VK_NULL_HANDLE, 1, &pipeline_info, nullptr, &m_graphics_pipeline_large))
        {
            throw std::runtime_error("failed to create graphics pipeline");
        }
    ...
    void CreateDepthResources()
    {
        ...
        m_depth_image_view = CreateImageView(m_depth_image, depth_format, VK_IMAGE_ASPECT_DEPTH_BIT | VK_IMAGE_ASPECT_STENCIL_BIT);
