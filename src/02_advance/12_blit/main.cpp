...
private:
    ...
    void RecordCommandBuffer(VkCommandBuffer command_buffer, VkFramebuffer framebuffer) const
    {
        ...
        clear_values.at(0).color = {
            {m_back_graound[0], m_back_graound[1], m_back_graound[2], 1.F}
        };
    ...
    void UpdateUniformBuffer(uint32_t current_image)
    {
        ...
        ubo.model = glm::rotate(glm::mat4(1.F), glm::radians(m_rotate_angle), glm::vec3(m_rotate_axis[0], m_rotate_axis[1], m_rotate_axis[2]));
...
private:
    ...
    static void WriteImage(const std::string& file_name, FileType type, bool rgba, uint32_t w, uint32_t h, const uint8_t* data)
    {
        switch (type)
        {
            case FileType::PPM:
            ...
            case FileType::JPEG:
            {
                ...
                else
                {
                    ...
                    stbi_write_jpg((file_name + ".jpg").c_str(), static_cast<int>(w), static_cast<int>(h), 4, rgba_data.data(), 100);
                }
            }
            break;
            default:
