...
private:
  ...
  void CreateGraphicsPipeline() {
    ...
    vertex_input_info_separate.vertexBindingDescriptionCount =
      static_cast<uint32_t>(binding_descriptions_separate.size());
    vertex_input_info_separate.pVertexBindingDescriptions = binding_descriptions_separate.data();
    vertex_input_info_separate.vertexAttributeDescriptionCount =
      static_cast<uint32_t>(attribute_descriptions_separate.size());
  ...
  void CreateVertexBufferAttributes() {
    auto tmp_create_vertex_buffer = [this](VkBuffer& buffer, VkDeviceMemory& memory, VkDeviceSize buffer_size,
