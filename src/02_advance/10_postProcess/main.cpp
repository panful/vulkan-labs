...
private:
    ...
    {
        auto vertShaderCode = ReadFile("../assets/shaders/02_10_quad_vert.spv");
        auto fragShaderCode = ReadFile("../assets/shaders/02_10_quad_frag.spv");
    ...
    {
        auto vertShaderCode = ReadFile("../assets/shaders/02_10_base_vert.spv");
        auto fragShaderCode = ReadFile("../assets/shaders/02_10_base_frag.spv");
