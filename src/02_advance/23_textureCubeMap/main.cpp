...
private:
  ...
  std::array<std::tuple<VkBuffer, VkDeviceMemory, uint32_t, uint32_t>, 6> LoadCubeMap() {
    std::array<std::string, 6> cube_texture_names{
      PROJECT_ASSETS_DIR "textures/skybox/skybox_right.jpg", PROJECT_ASSETS_DIR "textures/skybox/skybox_left.jpg",
      PROJECT_ASSETS_DIR "textures/skybox/skybox_top.jpg",   PROJECT_ASSETS_DIR "textures/skybox/skybox_bottom.jpg",
      PROJECT_ASSETS_DIR "textures/skybox/skybox_front.jpg", PROJECT_ASSETS_DIR "textures/skybox/skybox_back.jpg",
    };
    ...
    for (uint32_t i = 0; i < 6; ++i) {
      ...
      ret_val[i] = std::forward_as_tuple(staging_buffer, staging_buffer_memory, static_cast<uint32_t>(width),
  ...
  void CreateTexture(Texture& texture) {
    ...
    CreateImage(width, height, VK_FORMAT_R8G8B8A8_SRGB, VK_IMAGE_TILING_OPTIMAL,
                ...
                texture.image, texture.memory, true);
    ...
    texture.imageView =
      CreateImageView(texture.image, VK_FORMAT_R8G8B8A8_SRGB, VK_IMAGE_ASPECT_COLOR_BIT, VK_IMAGE_VIEW_TYPE_CUBE);
  }
