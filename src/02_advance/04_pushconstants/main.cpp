...
private:
    ...
    {
        auto vertShaderCode = ReadFile("../assets/shaders/02_04_base_vert.spv");
        auto fragShaderCode = ReadFile("../assets/shaders/02_04_base_frag.spv");
...
private:
    ...
    void CreateGraphicsPipeline()
    {
        auto vertShaderCode = ReadFile("../assets/shaders/02_04_base2_vert.spv");
        auto fragShaderCode = ReadFile("../assets/shaders/02_04_base2_frag.spv");
...
private:
    ...
    void CreateGraphicsPipeline()
    {
        auto vertShaderCode = ReadFile("../assets/shaders/02_04_base3_vert.spv");
        auto fragShaderCode = ReadFile("../assets/shaders/02_04_base3_frag.spv");
