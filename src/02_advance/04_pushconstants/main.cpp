...
private:
    ...
    void CreateGraphicsPipeline()
    {
        auto vertShaderCode = ReadFile(PROJECT_ASSETS_DIR "shaders/02_04_base3_vert.spv");
        auto fragShaderCode = ReadFile(PROJECT_ASSETS_DIR "shaders/02_04_base3_frag.spv");
