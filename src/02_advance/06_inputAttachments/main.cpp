...
private:
        ...
        for (size_t i = 0; i < m_swap_chain_image_views.size(); ++i)
        {
            ...
            if (s_index > 0)
            {
                ...
                vkCmdPipelineBarrier(
                    command_buffer, VK_PIPELINE_STAGE_TOP_OF_PIPE_BIT, VK_PIPELINE_STAGE_FRAGMENT_SHADER_BIT, 0, 0, nullptr, 0, nullptr, 1, &barrier
                );
    ...
    void CreateFramebuffers()
    {
        ...
        for (size_t i = 0; i < m_swap_chain_image_views.size(); ++i)
        {
            ...
            std::array<VkImageView, 3> attachments {m_swap_chain_image_views[i], m_attachment_view_color[i], m_attachment_view_depth[i]};
    ...
    void RecordCommandBuffer(VkCommandBuffer command_buffer, VkFramebuffer framebuffer) const
    {
        ...
        clear_values.at(2).depthStencil = {1.F, 0}; // Vulkan 的深度范围是 [0.0, 1.0] 1.0对应视锥体的远平面，初始化时应该设置为远平面的值
