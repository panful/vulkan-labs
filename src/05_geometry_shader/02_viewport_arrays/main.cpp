...
private:
  ...
  void CreateGraphicsPipeline() {
    auto vert_shader_code = ReadFile(PROJECT_SHADER_DIR "05_02_base_vert.spv");
    auto frag_shader_code = ReadFile(PROJECT_SHADER_DIR "05_02_base_frag.spv");
    auto geom_shader_code = ReadFile(PROJECT_SHADER_DIR "05_02_base_geom.spv");
