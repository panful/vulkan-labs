...
int main() {
  try {
    ...
    //--------------------------------------------------------------------------------------
    std::vector<uint32_t> vert_spv = ReadFile(PROJECT_SHADER_DIR "07_01_base_vert.spv");
    std::vector<uint32_t> frag_spv = ReadFile(PROJECT_SHADER_DIR "07_01_base_frag.spv");
