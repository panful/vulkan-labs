...
int main()
{
    try
    {
        ...
        //--------------------------------------------------------------------------------------
        std::vector<uint32_t> vertSPV = ReadFile(PROJECT_ASSETS_DIR "shaders/01_02_base_vert.spv");
        std::vector<uint32_t> fragSPV = ReadFile(PROJECT_ASSETS_DIR "shaders/01_02_base_frag.spv");
