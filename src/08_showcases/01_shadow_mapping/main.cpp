...
private:
  ...
  void CreateGraphicsPipelineLight() {
    auto vert_shader_code = ReadFile(PROJECT_SHADER_DIR "08_01_light_vert.spv");
    auto frag_shader_code = ReadFile(PROJECT_SHADER_DIR "08_01_light_frag.spv");
  ...
  void CreateGraphicsPipeline() {
    auto vert_shader_code = ReadFile(PROJECT_SHADER_DIR "08_01_base_vert.spv");
    auto frag_shader_code = ReadFile(PROJECT_SHADER_DIR "08_01_base_frag.spv");
