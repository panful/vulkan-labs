...
private:
  ...
  void CreateGraphicsPipelineOffscreen(Offscreen& offscreen) {
    auto vert_shader_code = ReadFile(PROJECT_SHADER_DIR "08_02_base_vert.spv");
    auto frag_shader_code = ReadFile(PROJECT_SHADER_DIR "08_02_base_frag.spv");
  ...
  void CreateGraphicsPipeline() {
    auto vert_shader_code = ReadFile(PROJECT_SHADER_DIR "08_02_hdr2ldr_vert.spv");
    auto frag_shader_code = ReadFile(PROJECT_SHADER_DIR "08_02_hdr2ldr_frag.spv");
