...
private:
    ...
    {
        auto vert_shader_code = ReadFile(PROJECT_ASSETS_DIR "shaders/01_05_base_vert.spv");
        auto frag_shader_code = ReadFile(PROJECT_ASSETS_DIR "shaders/01_05_base_frag.spv");
    ...
    void CreateTextureImage()
    {
        ...
        int tex_height {0};
        int tex_channels {0};
        auto pixels = stbi_load(PROJECT_ASSETS_DIR "textures/alpha.png", &tex_width, &tex_height, &tex_channels, STBI_rgb_alpha);
