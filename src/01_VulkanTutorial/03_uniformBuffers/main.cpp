...
private:
    ...
    void CreateGraphicsPipeline()
    {
        auto vertShaderCode = ReadFile(PROJECT_ASSETS_DIR "shaders/01_03_base2_vert.spv");
        auto fragShaderCode = ReadFile(PROJECT_ASSETS_DIR "shaders/01_03_base2_frag.spv");
