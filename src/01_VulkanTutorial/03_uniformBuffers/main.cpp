...
private:
    ...
    {
        auto vertShaderCode = ReadFile("../assets/shaders/01_03_base_vert.spv");
        auto fragShaderCode = ReadFile("../assets/shaders/01_03_base_frag.spv");
...
private:
    ...
    void CreateGraphicsPipeline()
    {
        auto vertShaderCode = ReadFile("../assets/shaders/01_03_base2_vert.spv");
        auto fragShaderCode = ReadFile("../assets/shaders/01_03_base2_frag.spv");
