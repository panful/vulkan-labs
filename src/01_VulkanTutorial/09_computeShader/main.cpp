...
private:
    ...
    {
        auto vertShaderCode = readFile("../assets/shaders/01_09_base_vert.spv");
        auto fragShaderCode = readFile("../assets/shaders/01_09_base_frag.spv");
    ...
    {
        auto computeShaderCode = readFile("../assets/shaders/01_09_base_comp.spv");
