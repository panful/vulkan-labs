...
private:
    ...
    {
        auto vertShaderCode = ReadFile("../assets/shaders/08_01_light_vert.spv");
        auto fragShaderCode = ReadFile("../assets/shaders/08_01_light_frag.spv");
    ...
    {
        auto vertShaderCode = ReadFile("../assets/shaders/08_01_base_vert.spv");
        auto fragShaderCode = ReadFile("../assets/shaders/08_01_base_frag.spv");
