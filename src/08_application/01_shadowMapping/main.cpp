...
private:
    ...
    {
        auto vertShaderCode = ReadFile(PROJECT_ASSETS_DIR "shaders/08_01_light_vert.spv");
        auto fragShaderCode = ReadFile(PROJECT_ASSETS_DIR "shaders/08_01_light_frag.spv");
    ...
    {
        auto vertShaderCode = ReadFile(PROJECT_ASSETS_DIR "shaders/08_01_base_vert.spv");
        auto fragShaderCode = ReadFile(PROJECT_ASSETS_DIR "shaders/08_01_base_frag.spv");
