...
private:
    ...
    {
        auto vertShaderCode = ReadFile("../assets/shaders/08_02_base_vert.spv");
        auto fragShaderCode = ReadFile("../assets/shaders/08_02_base_frag.spv");
    ...
    {
        auto vertShaderCode = ReadFile("../assets/shaders/08_02_hdr2ldr_vert.spv");
        auto fragShaderCode = ReadFile("../assets/shaders/08_02_hdr2ldr_frag.spv");
