...
private:
    ...
    void TransitionImageLayout(VkImage image, VkFormat /*format*/, VkImageLayout old_layout, VkImageLayout new_layout) const
    {
        ...
        else if (VK_IMAGE_LAYOUT_COLOR_ATTACHMENT_OPTIMAL == old_layout && VK_IMAGE_LAYOUT_PRESENT_SRC_KHR == new_layout)
        {
            barrier.srcAccessMask = VK_ACCESS_COLOR_ATTACHMENT_WRITE_BIT;
            barrier.dstAccessMask = 0;
        ...
        else if (VK_IMAGE_LAYOUT_UNDEFINED == old_layout && VK_IMAGE_LAYOUT_DEPTH_STENCIL_ATTACHMENT_OPTIMAL == new_layout)
        {
            barrier.srcAccessMask = 0;
            barrier.dstAccessMask = VK_ACCESS_DEPTH_STENCIL_ATTACHMENT_WRITE_BIT;
    ...
    void RecordCommandBuffer(VkCommandBuffer command_buffer, const uint32_t image_index) const
    {
        ...
        TransitionImageLayout(
            m_swap_chain_images[image_index], m_swap_chain_image_format, VK_IMAGE_LAYOUT_UNDEFINED, VK_IMAGE_LAYOUT_COLOR_ATTACHMENT_OPTIMAL
        );

        TransitionImageLayout(m_depth_image, FindDepthFormat(), VK_IMAGE_LAYOUT_UNDEFINED, VK_IMAGE_LAYOUT_DEPTH_STENCIL_ATTACHMENT_OPTIMAL);
        ...
        TransitionImageLayout(
            m_swap_chain_images[image_index], m_swap_chain_image_format, VK_IMAGE_LAYOUT_COLOR_ATTACHMENT_OPTIMAL, VK_IMAGE_LAYOUT_PRESENT_SRC_KHR
        );
