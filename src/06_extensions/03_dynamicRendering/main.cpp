...
private:
  ...
  void RecordCommandBuffer(VkCommandBuffer commandBuffer, const uint32_t imageIndex) const {
    ...
    TransitionImageLayout(m_swapChainImages[imageIndex], m_swapChainImageFormat, VK_IMAGE_LAYOUT_UNDEFINED,
                          VK_IMAGE_LAYOUT_COLOR_ATTACHMENT_OPTIMAL);

    TransitionImageLayout(m_depthImage, FindDepthFormat(), VK_IMAGE_LAYOUT_UNDEFINED,
    ...
    TransitionImageLayout(m_swapChainImages[imageIndex], m_swapChainImageFormat,
