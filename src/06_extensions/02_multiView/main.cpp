...
private:
  ...
  void CreateMultiViewGraphicsPipeline() {
    auto vert_shader_code = ReadFile(PROJECT_ASSETS_DIR "shaders/06_02_multiView_vert.spv");
    auto frag_shader_code = ReadFile(PROJECT_ASSETS_DIR "shaders/06_02_multiView_frag.spv");
