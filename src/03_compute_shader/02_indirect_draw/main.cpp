...
private:
  ...
  void CreateComputePipeline() {
    auto compute_shader_code = ReadFile(PROJECT_SHADER_DIR "03_02_base_comp.spv");
  ...
  void CreateGraphicsPipeline() {
    auto vert_shader_code = ReadFile(PROJECT_SHADER_DIR "03_02_base_vert.spv");
    auto frag_shader_code = ReadFile(PROJECT_SHADER_DIR "03_02_base_frag.spv");
