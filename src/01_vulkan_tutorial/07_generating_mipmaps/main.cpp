...
private:
  ...
  void CreateTextureImage() {
    ...
    CreateImage(tex_width, tex_height, m_mip_levels, VK_FORMAT_R8G8B8A8_SRGB, VK_IMAGE_TILING_OPTIMAL,
  ...
  /// @param image
  /// @param imageMemory
  void CreateImage(uint32_t width, uint32_t height, uint32_t mip_levels, VkFormat format, VkImageTiling tiling,
  ...
  void CreateDepthResources() {
    ...
    CreateImage(m_swap_chain_extent.width, m_swap_chain_extent.height, 1, depth_format, VK_IMAGE_TILING_OPTIMAL,
