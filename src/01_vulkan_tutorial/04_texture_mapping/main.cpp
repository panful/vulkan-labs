...
private:
  ...
  void CreateGraphicsPipeline() {
    auto vert_shader_code = ReadFile(PROJECT_SHADER_DIR "01_04_base_vert.spv");
    auto frag_shader_code = ReadFile(PROJECT_SHADER_DIR "01_04_base_frag.spv");
  ...
  void CreateTextureImage() {
    ...
    int tex_channels{0};
    auto pixels =
      stbi_load(PROJECT_ASSETS_DIR "textures/alpha.png", &tex_width, &tex_height, &tex_channels, STBI_rgb_alpha);
  ...
  void CreateTextureImageView() { m_texture_image_view = CreateImageView(m_texture_image, VK_FORMAT_R8G8B8A8_SRGB); }
