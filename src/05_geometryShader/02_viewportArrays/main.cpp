...
private:
    ...
    {
        auto vertShaderCode = ReadFile("../assets/shaders/05_02_base_vert.spv");
        auto fragShaderCode = ReadFile("../assets/shaders/05_02_base_frag.spv");
        auto geomShaderCode = ReadFile("../assets/shaders/05_02_base_geom.spv");
