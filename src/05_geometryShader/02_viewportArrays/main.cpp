...
private:
    ...
    {
        auto vertShaderCode = ReadFile(PROJECT_ASSETS_DIR "shaders/05_02_base_vert.spv");
        auto fragShaderCode = ReadFile(PROJECT_ASSETS_DIR "shaders/05_02_base_frag.spv");
        auto geomShaderCode = ReadFile(PROJECT_ASSETS_DIR "shaders/05_02_base_geom.spv");
