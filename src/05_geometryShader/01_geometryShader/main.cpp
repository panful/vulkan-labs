...
private:
    ...
    {
        auto vertShaderCode = ReadFile("../assets/shaders/05_01_base_vert.spv");
        auto fragShaderCode = ReadFile("../assets/shaders/05_01_base_frag.spv");
        auto geomShaderCode = ReadFile("../assets/shaders/05_01_base_geom.spv");
