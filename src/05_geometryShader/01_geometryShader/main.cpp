...
private:
  ...
  void CreateGraphicsPipeline() {
    auto vert_shader_code = ReadFile(PROJECT_ASSETS_DIR "shaders/05_01_base_vert.spv");
    auto frag_shader_code = ReadFile(PROJECT_ASSETS_DIR "shaders/05_01_base_frag.spv");
    auto geom_shader_code = ReadFile(PROJECT_ASSETS_DIR "shaders/05_01_base_geom.spv");
    ...
    input_assembly.topology = VK_PRIMITIVE_TOPOLOGY_POINT_LIST;  // 指定绘制的图元类型：点、线、三角形
