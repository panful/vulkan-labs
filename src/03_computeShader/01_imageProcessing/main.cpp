...
private:
    ...
    {
        auto computeShaderCode = ReadFile("../assets/shaders/03_01_base_comp.spv");
    ...
    {
        auto vertShaderCode = ReadFile("../assets/shaders/03_01_base_vert.spv");
        auto fragShaderCode = ReadFile("../assets/shaders/03_01_base_frag.spv");
    ...
    void CreateTextureImage()
    {
        ...
        auto pixels = stbi_load("../assets/textures/nightsky.png", &m_textureWidth, &m_textureHeight, &texChannels, STBI_rgb_alpha);
