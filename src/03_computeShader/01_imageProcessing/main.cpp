...
private:
    ...
    {
        auto computeShaderCode = ReadFile(PROJECT_ASSETS_DIR "shaders/03_01_base_comp.spv");
    ...
    {
        auto vertShaderCode = ReadFile(PROJECT_ASSETS_DIR "shaders/03_01_base_vert.spv");
        auto fragShaderCode = ReadFile(PROJECT_ASSETS_DIR "shaders/03_01_base_frag.spv");
    ...
    void CreateTextureImage()
    {
        ...
        auto pixels = stbi_load(PROJECT_ASSETS_DIR "textures/nightsky.png", &m_textureWidth, &m_textureHeight, &texChannels, STBI_rgb_alpha);
    ...
    )
    {
        ...
        std::set<uint32_t> uniqueQueueFamilyIndices {
            m_queueFamilyIndices.graphicsFamily.value(), m_queueFamilyIndices.computeFamily.value(), m_queueFamilyIndices.transferFamily.value()
        };
