...
private:
    ...
    {
        auto computeShaderCode = ReadFile("../assets/shaders/03_02_base_comp.spv");
    ...
    {
        auto vertShaderCode = ReadFile("../assets/shaders/03_02_base_vert.spv");
        auto fragShaderCode = ReadFile("../assets/shaders/03_02_base_frag.spv");
